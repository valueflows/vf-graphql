...
type Intent {
  ...
  "The base quantity of the offer or request, which can be multipied for an actual commitment.  Used for example for a price list."
  exchangeRateQuantity: QuantityValue
