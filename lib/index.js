...
function buildSchema(moduleIds, extensionSchemas) {
  ...
  return buildASTSchema(mergeTypeDefs(fragments.concat(extensionSchemas || []), { throwOnConflict: true, assumeValidSDL: true }))
}
