...
function buildSchema(moduleIds) {
  ...
  return buildASTSchema(mergeTypeDefs(fragments, { throwOnConflict: true }))
}

module.exports = {
  buildSchema,
  printSchema,
  validate: (oSchema, moduleIds) => findBreakingChanges(buildSchema(moduleIds), oSchema),
}
